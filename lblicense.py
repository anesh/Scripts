...
def usage ():
    print "Usage:"
    print "%s --bigip <IP|hostname> --username <username> --server <license_server_hostname> \
...
def get_license_from_F5_License_Server ( server_hostname, dossier_string, eula_string, email,
    ...
    try:
        ...
        proxy_settings = dict(http='http://username:password%40111@127.0.0.1:8000', https='http://username:password%40111@127.0.0.1:8000') 
...
#Misc EULA Variables
email  = "anesh.kesavan@domain.com"
firstName = "anesh"
lastName = "kesavan"
companyName = "test"
phone = "9"
...
if options.bigips and options.uname:
